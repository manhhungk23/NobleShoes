      ...
      <div class="sidebar-logo">
        ...
        <div class="logo-header" data-background-color="yellow">
          <router-link to="/admin/trang-chu" class="logo">
            <img src="/src/assets/img/logoo-Photoroom.png" alt="navbar brand" class="navbar-brand" height="140" />
          </router-link>
        </div>
        <!-- End Logo Header -->
      </div>
      <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
          <ul class="nav nav-secondary">
            ...
            <li class="nav-item">
              <a class="collapsed" data-bs-toggle="collapse" data-bs-target="#banHang" href="#" aria-expanded="false">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav nav-collapse">
                  ...
                  <li>
                    <router-link to="/admin/muc-dich-su-dung">
                      <span class="sub-item">Mục đích sử dụng</span>
                    </router-link>
                  </li>
                  <li>
                    <router-link to="/admin/day-giay">
                      <span class="sub-item">Dây giầy</span>
                    </router-link>
                  </li>
                  <li>
                    <router-link to="/admin/de-giay">
                      <span class="sub-item">Đế giầy</span>
                    </router-link>
                  </li>
                  <li>
